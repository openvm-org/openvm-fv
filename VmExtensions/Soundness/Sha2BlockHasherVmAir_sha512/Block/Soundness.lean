/- 
Final assembly for SHA-512 block soundness.
-/
import VmExtensions.Soundness.Sha2BlockHasherVmAir_sha512.Block.Support
...
/-- Proof-friendly block-side boundary for SHA-512 opcode
packaging. It exposes exactly the local window, schedule, and compression facts
needed by the opcode layer. -/
