import VmExtensions.Soundness.Sha2MainAir_sha512.Bus
...
def sharedWrapperPayloadSpec
  ...
  let mainState := Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row
  let blockState := Sha2BlockHasherVmAir_sha512.constraints.wrapperStateEntry blockAir (start + 20)
  let mainMsg1 := Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row
  let blockMsg1 := Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg1Entry blockAir start
  let mainMsg2 := Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row
  let blockMsg2 := Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg2Entry blockAir (start + 2)
  (∀ i : Fin 32, mainState.prev_state_u16.get i = blockState.prev_state_u16.get i) ∧
  (∀ i : Fin 64, mainState.new_state_bytes.get i = blockState.new_state_bytes.get i) ∧
  (∀ i : Fin 32, mainMsg1.local_msg_bytes.get i = blockMsg1.local_msg_bytes.get i) ∧
  (∀ i : Fin 32, mainMsg1.next_msg_bytes.get i = blockMsg1.next_msg_bytes.get i) ∧
  (∀ i : Fin 32, mainMsg2.local_msg_bytes.get i = blockMsg2.local_msg_bytes.get i) ∧
  (∀ i : Fin 32, mainMsg2.next_msg_bytes.get i = blockMsg2.next_msg_bytes.get i)

theorem mainWrapperState_raw_head
    (mainAir : CMain FBB ExtF) (row : ℕ) :
    List.head? ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2) = some 0 := by
  simp [Sha2MainAir_sha512.constraints.wrapperStateEntry]

theorem mainWrapperMsg1_raw_head
    (mainAir : CMain FBB ExtF) (row : ℕ) :
    List.head? ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2) = some 1 := by
  simp [Sha2MainAir_sha512.constraints.wrapperMsg1Entry]

theorem mainWrapperMsg2_raw_head
    (mainAir : CMain FBB ExtF) (row : ℕ) :
    List.head? ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2) = some 2 := by
  simp [Sha2MainAir_sha512.constraints.wrapperMsg2Entry]
...
theorem mainWrapperState_raw_request
    (mainAir : CMain FBB ExtF) (row : ℕ) :
    List.head? (List.tail ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2)) =
      some (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).request_id := by
  simp [Sha2MainAir_sha512.constraints.wrapperStateEntry]

theorem mainWrapperMsg1_raw_request
    (mainAir : CMain FBB ExtF) (row : ℕ) :
    List.head? (List.tail ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2)) =
      some (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).request_id := by
  simp [Sha2MainAir_sha512.constraints.wrapperMsg1Entry]

theorem mainWrapperMsg2_raw_request
    (mainAir : CMain FBB ExtF) (row : ℕ) :
    List.head? (List.tail ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2)) =
      some (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).request_id := by
  simp [Sha2MainAir_sha512.constraints.wrapperMsg2Entry]
...
theorem mainWrapperState_raw_prev
    ...
    ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2)[i.1 + 2]? =
      some ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).prev_state_u16.get i) := by
  exact prefixed_vectors_get_left
    (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).message_type
    (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).request_id
    (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).prev_state_u16
    (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).new_state_bytes i

theorem mainWrapperState_raw_new
    (mainAir : CMain FBB ExtF) (row : ℕ) (i : Fin 64) :
    ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2)[i.1 + 34]? =
      some ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).new_state_bytes.get i) := by
...
theorem blockWrapperState_raw_new
    (blockAir : CBlock FBB ExtF) (row : ℕ) (i : Fin 64) :
    ((wrapperStateEntry blockAir row).toRaw.2)[i.1 + 34]? =
...
theorem mainWrapperMsg1_raw_local
    (mainAir : CMain FBB ExtF) (row : ℕ) (i : Fin 32) :
    ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2)[i.1 + 2]? =
      some ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).local_msg_bytes.get i) := by
  exact prefixed_vectors_get_left
    (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).message_type
    (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).request_id
    (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).local_msg_bytes
    (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).next_msg_bytes i

theorem mainWrapperMsg1_raw_next
    (mainAir : CMain FBB ExtF) (row : ℕ) (i : Fin 32) :
    ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2)[i.1 + 34]? =
      some ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).next_msg_bytes.get i) := by
  simpa [Nat.add_assoc, Nat.add_left_comm, Nat.add_comm] using
    (prefixed_vectors_get_right
      (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).message_type
      (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).request_id
...
theorem blockWrapperMsg1_raw_next
    (blockAir : CBlock FBB ExtF) (row : ℕ) (i : Fin 32) :
    ((wrapperMsg1Entry blockAir row).toRaw.2)[i.1 + 34]? =
...
theorem mainWrapperMsg2_raw_local
    (mainAir : CMain FBB ExtF) (row : ℕ) (i : Fin 32) :
    ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2)[i.1 + 2]? =
      some ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).local_msg_bytes.get i) := by
  exact prefixed_vectors_get_left
    (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).message_type
    (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).request_id
    (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).local_msg_bytes
    (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).next_msg_bytes i

theorem mainWrapperMsg2_raw_next
    (mainAir : CMain FBB ExtF) (row : ℕ) (i : Fin 32) :
    ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2)[i.1 + 34]? =
      some ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).next_msg_bytes.get i) := by
  simpa [Nat.add_assoc, Nat.add_left_comm, Nat.add_comm] using
    (prefixed_vectors_get_right
      (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).message_type
      (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).request_id
...
theorem blockWrapperMsg2_raw_next
    (blockAir : CBlock FBB ExtF) (row : ℕ) (i : Fin 32) :
    ((wrapperMsg2Entry blockAir row).toRaw.2)[i.1 + 34]? =
...
theorem mem_mainWrapperTrace_iff
    ...
    (entry : FBB × List FBB) :
    entry ∈ Sha2MainAir_sha512.constraints.wrapperBus_trace mainAir ↔
      ∃ row, row ≤ Circuit.last_row mainAir ∧
        entry ∈ Sha2MainAir_sha512.constraints.wrapperBus_row mainAir row := by
  constructor
  · intro hentry
    rw [Sha2MainAir_sha512.constraints.wrapperBus_trace] at hentry
  ...
  · rintro ⟨row, hvalid, hentry_row⟩
    rw [Sha2MainAir_sha512.constraints.wrapperBus_trace]
...
theorem mem_blockWrapperTrace_iff
    ...
    (entry : FBB × List FBB) :
    entry ∈ Sha2BlockHasherVmAir_sha512.constraints.wrapperBus_trace blockAir ↔
      ∃ row, row ≤ Circuit.last_row blockAir ∧
        entry ∈ Sha2BlockHasherVmAir_sha512.constraints.wrapperBus_row blockAir row := by
  constructor
  · intro hentry
    rw [Sha2BlockHasherVmAir_sha512.constraints.wrapperBus_trace] at hentry
    rcases List.mem_flatMap.mp hentry with ⟨row, hrow_mem, hentry_row⟩
    exact ⟨row, Nat.lt_succ_iff.mp (List.mem_range.mp hrow_mem), hentry_row⟩
  · rintro ⟨row, hvalid, hentry_row⟩
    rw [Sha2BlockHasherVmAir_sha512.constraints.wrapperBus_trace]
    exact List.mem_flatMap.mpr
      ⟨row, List.mem_range.mpr (Nat.lt_succ_of_le hvalid), hentry_row⟩
...
private theorem padding_choose2_is_bit_lookup :
    ∀ n0 n1 n2 n3 n4 n5 : Fin 3,
      ...
      ((2 - ((n0.val + n1.val + n2.val + n3.val + n4.val + n5.val : ℕ) : FBB)) *
        (1 - ((n0.val + n1.val + n2.val + n3.val + n4.val + n5.val : ℕ) : FBB)) *
...
theorem wrapperBus_padding_choose2_is_bit
  ...
  have hlookup :
    ...
    padding_choose2_is_bit_lookup n0 n1 n2 n3 n4 n5 htotal_le
  simpa [wrapperBus_padding_choose2, h0, h1, h2, h3, h4, h5] using hlookup

theorem wrapperBus_choose2_encoder5_is_bit
    (air : CBlock FBB ExtF) (row : ℕ)
    (hf : flag_constraints air row) :
    wrapperBus_choose2 (encoder_idx air 5 row) = 0 ∨
      wrapperBus_choose2 (encoder_idx air 5 row) = 1 := by
  rcases encoder_digits_ternary air row hf 5 (by omega) with h0 | h1 | h2
  · left
...
private theorem selector_two_implies_choose2_one_lookup :
    ∀ n0 n1 n2 n3 n4 n5 : Fin 3,
      n0.val + n1.val + n2.val + n3.val + n4.val + n5.val ≤ 2 →
      encoderSelectorPoly (n0.val : FBB) (n1.val : FBB) (n2.val : FBB)
        (n3.val : FBB) (n4.val : FBB) (n5.val : FBB) = 2 →
      ((n5.val : FBB) * ((n5.val : FBB) - 1) * wrapperBus_choose2_coeff : FBB) = 1 := by
  decide
...
theorem blockWrapperMsg1_active_implies_selector_zero
    ...
    (hf : flag_constraints air row)
    (hactive :
      (Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg1Entry air row).multiplicity = -1) :
  ...
  have hprod_one :
    ...
    have hactive' :
        -(wrapperBus_padding_choose2 air row *
          (is_round_row air row + is_digest_row air row)) = -1 := by
      simpa [Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg1Entry] using hactive
  ...
  have hpad_lookup :
      ((2 - ((n0.val + n1.val + n2.val + n3.val + n4.val + n5.val : ℕ) : FBB)) *
        (1 - ((n0.val + n1.val + n2.val + n3.val + n4.val + n5.val : ℕ) : FBB)) *
        wrapperBus_choose2_coeff : FBB) = 1 := by
    simpa [wrapperBus_padding_choose2, h0, h1, h2, h3, h4, h5] using hpad_one
  have hsel0 :
      encoderSelectorPoly (n0.val : FBB) (n1.val : FBB) (n2.val : FBB)
        (n3.val : FBB) (n4.val : FBB) (n5.val : FBB) = 0 :=
    padding_choose2_one_implies_selector_zero_lookup n0 n1 n2 n3 n4 n5 htotal_le hpad_lookup
  simpa [encoder_selector_idx, encoder_selector_from, encoder_digit_sum_from, encoderSelectorPoly,
    h0, h1, h2, h3, h4, h5] using hsel0
...
theorem blockWrapperMsg2_active_of_selector_two
    ...
    (Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg2Entry air row).multiplicity = -1 := by
  have hd0 := encoder_digits_ternary air row hf 0 (by omega)
  have hd1 := encoder_digits_ternary air row hf 1 (by omega)
  have hd2 := encoder_digits_ternary air row hf 2 (by omega)
  have hd3 := encoder_digits_ternary air row hf 3 (by omega)
  ...
  have hsel_lookup :
      encoderSelectorPoly (n0.val : FBB) (n1.val : FBB) (n2.val : FBB)
        (n3.val : FBB) (n4.val : FBB) (n5.val : FBB) = 2 := by
    simpa [encoder_selector_idx, encoder_selector_from, encoder_digit_sum_from, encoderSelectorPoly,
      h0, h1, h2, h3, h4, h5] using hsel
  have hchoose_lookup :
      ((n5.val : FBB) * ((n5.val : FBB) - 1) * wrapperBus_choose2_coeff : FBB) = 1 :=
    selector_two_implies_choose2_one_lookup n0 n1 n2 n3 n4 n5 htotal_le hsel_lookup
  have hchoose : wrapperBus_choose2 (encoder_idx air 5 row) = 1 := by
    simpa [wrapperBus_choose2, h5] using hchoose_lookup
  simpa [Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg2Entry, hreal, hchoose]
...
private theorem block_request_id_preserved_on_round
  ...
  have hreq : wrapper_request_id_constraints air row :=
    wrapper_request_id_constraints_of_blockHasherConstraints air hc row
  have hstep : next_request_id air row - request_id air row = 0 := by
    simpa [wrapper_request_id_constraints, constraint_1480,
      Sha2BlockHasherVmAir_Sha512Config.extraction.constraint_1480,
      Circuit.isTransitionRow, hrow.ne, hround, next_request_id, request_id] using hreq
...
/-- Request-id stability across one 21-row SHA-512 block window. -/
def blockRequestIdStableOnWindow
    (air : CBlock FBB ExtF) (start : ℕ) : Prop :=
  ∀ offset, offset ≤ 20 → request_id air (start + offset) = request_id air start
...
theorem block_request_id_eq_start
  ...
  | succ offset ih =>
      ...
      have hoffset_lt : offset < 20 := by omega
...
theorem blockRequestIdStableOnWindow_of_constraints
    (air : CBlock FBB ExtF) (start : ℕ)
    (hstart : start ≤ Circuit.last_row air)
    (hsel : encoder_selector_idx air start = 0)
    (hrot : rotation_consistent air)
    (hc : blockHasherConstraints air) :
    blockRequestIdStableOnWindow air start :=
  fun offset hoffset => block_request_id_eq_start air start offset hoffset hstart hsel hrot hc
...
theorem sharedWrapperPayloadSpec_of_raw_payload_eqs
    ...
    (hstate_raw :
      (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2 =
        (Sha2BlockHasherVmAir_sha512.constraints.wrapperStateEntry blockAir (start + 20)).toRaw.2)
    (hmsg1_raw :
      (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2 =
    ...
    (hmsg2_raw :
      (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2 =
        (Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg2Entry blockAir (start + 2)).toRaw.2) :
  ...
  · intro i
    have hraw :
        ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2)[i.1 + 2]? =
          ((wrapperStateEntry blockAir (start + 20)).toRaw.2)[i.1 + 2]? := by
      simpa using congrArg (fun payload => payload[i.1 + 2]?) hstate_raw
    apply Option.some.inj
    calc
      some ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).prev_state_u16.get i)
          = ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2)[i.1 + 2]? := by
            symm
            exact mainWrapperState_raw_prev mainAir row i
      _ = ((wrapperStateEntry blockAir (start + 20)).toRaw.2)[i.1 + 2]? := hraw
      _ = some ((wrapperStateEntry blockAir (start + 20)).prev_state_u16.get i) :=
            blockWrapperState_raw_prev blockAir (start + 20) i
  · intro i
    have hraw :
        ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2)[i.1 + 34]? =
          ((wrapperStateEntry blockAir (start + 20)).toRaw.2)[i.1 + 34]? := by
      simpa using congrArg (fun payload => payload[i.1 + 34]?) hstate_raw
    apply Option.some.inj
    calc
      some ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).new_state_bytes.get i)
          = ((Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir row).toRaw.2)[i.1 + 34]? := by
            symm
            exact mainWrapperState_raw_new mainAir row i
      _ = ((wrapperStateEntry blockAir (start + 20)).toRaw.2)[i.1 + 34]? := hraw
      _ = some ((wrapperStateEntry blockAir (start + 20)).new_state_bytes.get i) :=
            blockWrapperState_raw_new blockAir (start + 20) i
  · intro i
    have hraw :
        ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2)[i.1 + 2]? =
    ...
    apply Option.some.inj
    calc
      some ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).local_msg_bytes.get i)
          = ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2)[i.1 + 2]? := by
            symm
  ...
  · intro i
    have hraw :
        ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2)[i.1 + 34]? =
          ((wrapperMsg1Entry blockAir start).toRaw.2)[i.1 + 34]? := by
      simpa using congrArg (fun payload => payload[i.1 + 34]?) hmsg1_raw
    apply Option.some.inj
    calc
      some ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).next_msg_bytes.get i)
          = ((Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir row).toRaw.2)[i.1 + 34]? := by
            symm
            exact mainWrapperMsg1_raw_next mainAir row i
      _ = ((wrapperMsg1Entry blockAir start).toRaw.2)[i.1 + 34]? := hraw
  ...
  · intro i
    ...
    apply Option.some.inj
    calc
      some ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).local_msg_bytes.get i)
          = ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2)[i.1 + 2]? := by
            symm
  ...
  · intro i
    have hraw :
        ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2)[i.1 + 34]? =
          ((wrapperMsg2Entry blockAir (start + 2)).toRaw.2)[i.1 + 34]? := by
      simpa using congrArg (fun payload => payload[i.1 + 34]?) hmsg2_raw
    apply Option.some.inj
    calc
      some ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).next_msg_bytes.get i)
          = ((Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir row).toRaw.2)[i.1 + 34]? := by
            symm
            exact mainWrapperMsg2_raw_next mainAir row i
      _ = ((wrapperMsg2Entry blockAir (start + 2)).toRaw.2)[i.1 + 34]? := hraw
...
theorem mainWrapperTrace_perm_components
    ...
    (rows.flatMap (Sha2MainAir_sha512.constraints.wrapperBus_row mainAir)).Perm
      (rows.map (fun r => (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir r).toRaw) ++
        ...
        rows.map (fun r => (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir r).toRaw)) := by
  let stateRaw := fun r =>
    (Sha2MainAir_sha512.constraints.wrapperStateEntry mainAir r).toRaw
  let msg1Raw := fun r =>
    (Sha2MainAir_sha512.constraints.wrapperMsg1Entry mainAir r).toRaw
  let msg2Raw := fun r =>
    (Sha2MainAir_sha512.constraints.wrapperMsg2Entry mainAir r).toRaw
  have hstate :
      (rows.flatMap (Sha2MainAir_sha512.constraints.wrapperBus_row mainAir)).Perm
        (rows.map stateRaw ++ rows.flatMap (fun r => [msg1Raw r, msg2Raw r])) := by
    simpa [stateRaw, msg1Raw, msg2Raw, Sha2MainAir_sha512.constraints.wrapperBus_row] using
...
theorem blockWrapperTrace_perm_components
    ...
    (rows.flatMap (Sha2BlockHasherVmAir_sha512.constraints.wrapperBus_row blockAir)).Perm
      (rows.map (fun r => (Sha2BlockHasherVmAir_sha512.constraints.wrapperStateEntry blockAir r).toRaw) ++
        ...
        rows.map (fun r => (Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg2Entry blockAir r).toRaw)) := by
  let stateRaw := fun r =>
    (Sha2BlockHasherVmAir_sha512.constraints.wrapperStateEntry blockAir r).toRaw
  let msg1Raw := fun r =>
    (Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg1Entry blockAir r).toRaw
  let msg2Raw := fun r =>
    (Sha2BlockHasherVmAir_sha512.constraints.wrapperMsg2Entry blockAir r).toRaw
  have hstate :
      (rows.flatMap (Sha2BlockHasherVmAir_sha512.constraints.wrapperBus_row blockAir)).Perm
        (rows.map stateRaw ++ rows.flatMap (fun r => [msg1Raw r, msg2Raw r])) := by
    simpa [stateRaw, msg1Raw, msg2Raw, Sha2BlockHasherVmAir_sha512.constraints.wrapperBus_row] using
      (List.map_append_flatMap_perm rows stateRaw (fun r => [msg1Raw r, msg2Raw r])).symm
  have hmsgs :
      (rows.flatMap (fun r => [msg1Raw r, msg2Raw r])).Perm
        (rows.map msg1Raw ++ rows.map msg2Raw) := by
