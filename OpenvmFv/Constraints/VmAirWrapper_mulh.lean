...
namespace VmAirWrapper_mulh.constraints
  ...
  section constraint_simplification
    ...
    section row_constraints
      ...
      @[VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_air_simplification]
      lemma constraint_0_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_0 air row ↔ constraint_0 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
        exact h
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        exact h
      ...
      lemma constraint_1_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_1 air row ↔ constraint_1 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
      ...
      lemma constraint_2_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_2 air row ↔ constraint_2 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
      ...
      lemma constraint_3_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_3 air row ↔ constraint_3 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
      ...
      lemma constraint_4_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_4 air row ↔ constraint_4 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
      ...
      lemma constraint_5_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_5 air row ↔ constraint_5 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
      ...
      lemma constraint_6_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_6 air row ↔ constraint_6 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
      ...
      lemma constraint_7_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_7 air row ↔ constraint_7 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
    ...
    air.adapter.from_state.timestamp row 0 - air.adapter.reads_aux_0.base.prev_timestamp row 0 - 1 =
      ...
      lemma constraint_8_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_8 air row ↔ constraint_8 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
    ...
    air.adapter.from_state.timestamp row 0 + 1 - air.adapter.reads_aux_1.base.prev_timestamp row 0 - 1 =
      ...
      lemma constraint_9_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_9 air row ↔ constraint_9 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
    ...
    air.adapter.from_state.timestamp row 0 + 2 - air.adapter.writes_aux.base.prev_timestamp row 0 - 1 =
      ...
      lemma constraint_10_of_extraction
          (air : Valid_VmAirWrapper_mulh F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_10 air row ↔ constraint_10 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification]
    ...
    section interactions
      ...
      lemma constrain_execution_interactions
        ...
        (h : VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constrain_interactions air)
      :
        air.buses ExecutionBus = (List.range (air.last_row + 1)).flatMap (λ row => executionBus_row air row)
      := by
        unfold VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constrain_interactions at h
  ...
  section allHold
    ...
    : List Prop :=
      [
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_0 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_1 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_2 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_3 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_4 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_5 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_6 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_7 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_8 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_9 air row,
        VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constraint_10 air row,
      ]
    ...
    def allHold
      ...
      (_ : row ≤ air.last_row)
    : Prop :=
      VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constrain_interactions air ∧
    ...
    : allHold air row h_row ↔ allHold_simplified air row h_row := by
      ...
      apply Iff.and
      . unfold VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8.extraction.constrain_interactions
  ...
  section properties
    ...
    := by
      ...
      clear hint rest
      simp [VmAirWrapper_Rv32MultAdapterAir_MulHCoreAir_4_8_constraint_and_interaction_simplification] at *
