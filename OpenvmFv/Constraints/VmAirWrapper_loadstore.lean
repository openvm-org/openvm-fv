...
namespace VmAirWrapper_loadstore.constraints
  ...
  section constraint_simplification
    ...
    section row_constraints
      ...
      @[VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_air_simplification]
      lemma constraint_0_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_0 air row ↔ constraint_0 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
        exact h
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        exact h
      ...
      lemma constraint_1_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_1 air row ↔ constraint_1 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_2_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_2 air row ↔ constraint_2 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_3_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_3 air row ↔ constraint_3 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_4_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_4 air row ↔ constraint_4 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_5_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_5 air row ↔ constraint_5 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_6_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_6 air row ↔ constraint_6 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_7_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_7 air row ↔ constraint_7 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_8_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_8 air row ↔ constraint_8 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_9_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_9 air row ↔ constraint_9 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_10_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_10 air row ↔ constraint_10 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_11_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_11 air row ↔ constraint_11 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_12_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_12 air row ↔ constraint_12 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_13_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_13 air row ↔ constraint_13 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_14_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_14 air row ↔ constraint_14 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_15_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_15 air row ↔ constraint_15 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_16_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_16 air row ↔ constraint_16 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
    ...
    air.adapter.from_state.timestamp row 0 - air.adapter.rs1_aux_cols.base.prev_timestamp row 0 - 1 =
      ...
      lemma constraint_17_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_17 air row ↔ constraint_17 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_18_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_18 air row ↔ constraint_18 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_19_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_19 air row ↔ constraint_19 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_20_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_20 air row ↔ constraint_20 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
    ...
    air.adapter.mem_as row 0 - air.is_store row 0 * 2 = 2
      ...
      lemma constraint_21_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_21 air row ↔ constraint_21 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
      ...
      lemma constraint_22_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_22 air row ↔ constraint_22 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
    ...
    air.adapter.from_state.timestamp row 0 + 1 - air.adapter.read_data_aux.base.prev_timestamp row 0 - 1 =
      ...
      lemma constraint_23_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_23 air row ↔ constraint_23 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
    ...
    air.adapter.from_state.timestamp row 0 + 2 - air.adapter.write_base_aux.prev_timestamp row 0 - 1 =
      ...
      lemma constraint_24_of_extraction
          (air : Valid_VmAirWrapper_loadstore F ExtF) (row : ℕ)
      : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_24 air row ↔ constraint_24 air row := by
      apply Iff.intro
      . intro h
        simp [openvm_encapsulation, VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification] at h
        simp only [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
    ...
    section interactions
      ...
      lemma constrain_execution_interactions
        ...
        (h : VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constrain_interactions air)
      :
        air.buses ExecutionBus = (List.range (air.last_row + 1)).flatMap (λ row => executionBus_row air row)
      := by
        unfold VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constrain_interactions at h
  ...
  section allHold
    ...
    : List Prop :=
      [
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_0 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_1 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_2 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_3 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_4 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_5 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_6 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_7 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_8 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_9 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_10 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_11 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_12 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_13 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_14 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_15 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_16 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_17 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_18 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_19 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_20 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_21 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_22 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_23 air row,
        VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constraint_24 air row,
      ]
    ...
    def allHold
      ...
      (_ : row ≤ air.last_row)
    : Prop :=
      VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constrain_interactions air ∧
    ...
    : allHold air row h_row ↔ allHold_simplified air row h_row := by
      ...
      apply Iff.and
      . unfold VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4.extraction.constrain_interactions
...
:= by
  ...
  simp_all [VmAirWrapper_Rv32LoadStoreAdapterAir_LoadStoreCoreAir_4_constraint_and_interaction_simplification]
