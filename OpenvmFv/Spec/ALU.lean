...
-- Point of entry : multiplicity of the initial balancer is 1
...
lemma is_valid : air.core.is_valid 0 0 = 1 := by
...
lemma eq_b_and_c_non_imm
  (imm : air.adapter.rs2_as 0 0 = 1)
:
  ...
  c0.val < 256 ∧ c1.val < 256 ∧ c2.val < 256 ∧ c3.val < 256 ∧
...
:= by
  ...
  obtain ⟨ m0, m1, m2, m3, m4, m5 ⟩ :=  balanced_memory; clear m5
  simp_all [Vector.get]
  omega
...
:= by
  ...
  -- Get more detailed argument information
  specialize eq_b_and_c_non_imm non_imm
  obtain ⟨ eq_b0, eq_b1, eq_b2, eq_b3, eq_c0, eq_c1, eq_c2, eq_c3,
           ub_b0, ub_b1, ub_b2, ub_b3, ub_c0, ub_c1, ub_c2, ub_c3,
           eqv_b0, eqv_b1, eqv_b2, eqv_b3, eqv_c0, eqv_c1, eqv_c2, eqv_c3 ⟩ := eq_b_and_c_non_imm
