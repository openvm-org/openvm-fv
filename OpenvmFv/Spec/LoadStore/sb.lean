...
namespace PureSpec
  ...
  := by
    ...
    replace h_clint_base := clint_base_of_write_state sb_input.PC h_plat_clint_base_val
    replace h_clint_size := clint_size_of_write_state sb_input.PC h_plat_clint_size_val
    replace h_plat_ram_base := ram_base_of_write_state sb_input.PC h_plat_ram_base_val
    replace h_plat_ram_size := ram_size_of_write_state sb_input.PC h_plat_ram_size
    replace h_plat_rom_base := rom_base_of_write_state sb_input.PC h_plat_rom_base_val
    replace h_plat_rom_size := rom_size_of_write_state sb_input.PC h_plat_rom_size_val
    replace h_htif_tohost_base := htif_tohost_base_of_write_state sb_input.PC h_plat_htif_tohost_base_val
