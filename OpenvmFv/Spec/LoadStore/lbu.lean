...
namespace PureSpec
  ...
  := by
    ...
    replace h_clint_base := clint_base_of_write_state lbu_input.PC h_plat_clint_base_val
    replace h_clint_size := clint_size_of_write_state lbu_input.PC h_plat_clint_size_val
    replace h_plat_ram_base := ram_base_of_write_state lbu_input.PC h_plat_ram_base_val
