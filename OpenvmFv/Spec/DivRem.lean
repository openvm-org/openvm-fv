...
(h_b_ext : b_ext = U32.ext #v[b0, b1, b2, b3] true)
(h_c_ext : c_ext = U32.ext #v[c0, c1, c2, c3] true)
(h_q_ext : q_ext = if U32.toInt #v[q0, q1, q2, q3] = 0 then 0 else (if (b_ext = c_ext) then 0 else 255))
:
  q_ext = U32.ext #v[q0, q1, q2, q3] true ∧ b_ext = U32.ext #v[r0, r1, r2, r3] true
:= by
  have h_bv_eq :=
    @divrem_split
  ...
  . zify at h_q_nz_n
    ...
    . simp_all [-BabyBear.to_the_right_FBB_255]
      ...
      . rw [eq_q] at this; zify at this ⊢; clear *- this; omega
    ...
    . simp_all [-BabyBear.to_the_right_FBB_255]
      ...
      have ⟨ lb_r, ub_r ⟩ :
        ...
        (r0 : ℤ) + ↑↑r1 * 256 + ↑↑r2 * 65536 + ↑↑r3 * 16777216 < 4294967296
      := by clear *- ub_r0 ub_r1 ub_r2 ub_r3 h_r_nz; omega
      clear h_cond_bext h_cond_cext h_b_ext h_c_ext h_q_ext h_q_nz_n
      clear h_c_ext h_q_ext
    ...
    . simp_all [-BabyBear.to_the_right_FBB_0]
      ...
      have ⟨ lb_r, ub_r ⟩ :
        ...
        (r0 : ℤ) + ↑↑r1 * 256 + ↑↑r2 * 65536 + ↑↑r3 * 16777216 < 4294967296
      := by clear *- ub_r0 ub_r1 ub_r2 ub_r3 h_r_nz; omega
      clear h_cond_bext h_cond_cext h_r_nz
      obtain ⟨ c, eq_c ⟩ : exists c, c = (c0 : ℤ) + ↑↑c1 * 256 + ↑↑c2 * 65536 + ↑↑c3 * 16777216 := by simp
      obtain ⟨ q, eq_q ⟩ : exists q, q = (q0 : ℤ) + ↑↑q1 * 256 + ↑↑q2 * 65536 + ↑↑q3 * 16777216 := by simp
      obtain ⟨ r, eq_r ⟩ : exists r, r = (r0 : ℤ) + ↑↑r1 * 256 + ↑↑r2 * 65536 + ↑↑r3 * 16777216 := by simp
      ...
      . replace lb_c : 0 < c := by clear *- h_c_nz eq_c ub_c0 ub_c1 ub_c2 ub_c3; rw [eq_c]; omega
        ...
        rw [← eq_c] at ub_c lb_b ub_b; clear h_c_nz eq_c ub_c0 ub_c1 ub_c2 ub_c3 c0 c1 c2 c3
