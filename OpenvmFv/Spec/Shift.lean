...
theorem spec_base_SRL
  (h_srl : air.core.opcode_srl_flag row 0 = 1)
:
  (U32.toBV #v[(air.core.a_0 row 0).val,
               (air.core.a_1 row 0).val,
               (air.core.a_2 row 0).val,
...
:= by
  ...
  obtain ⟨ h00, h01, h02, h03, h04, h05, h06, h07, h08, h09,
           ...
           h50, h51, h52, h53, h54, h55, h56, h57, h58, h59,
           h60, h61, h62, h63, h64, h65, h66, rest ⟩ := rest
  have h_sra : air.core.opcode_sra_flag row 0 = 0 := by clear *- h_srl sop1; grind
  simp [h_srl, h_sra] at *
...
:= by
  ...
  rcases opcodes with sll | srl | sra <;> simp_all [rop_of_Shift_opcode]
  . apply spec_base_SLL <;> assumption
  . apply spec_base_SRL <;> assumption
  . sorry
