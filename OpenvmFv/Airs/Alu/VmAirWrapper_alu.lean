...
def Valid_VmAirWrapper_alu.rs2_limbs
  [Field F]
  [Field ExtF]
...
def Valid_VmAirWrapper_alu.rs2_sign
  [Field F]
  [Field ExtF]
  (c : Valid_VmAirWrapper_alu F ExtF)
  (row rotation : ℕ)
...
lemma VmAirWrapper_alu.rs2_imm_def
  [Field F]
  [Field ExtF]
  (c : Valid_VmAirWrapper_alu F ExtF)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma VmAirWrapper_alu.rs2_sign_limbs
  [Field F]
  [Field ExtF]
  (c : Valid_VmAirWrapper_alu F ExtF)
  (row rotation: ℕ)
...
lemma VmAirWrapper_alu.rs2_sign_check
  [Field F]
  [Field ExtF]
  (c : Valid_VmAirWrapper_alu F ExtF)
  (row rotation: ℕ)
