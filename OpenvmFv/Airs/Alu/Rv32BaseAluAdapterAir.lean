...
def Rv32BaseAluAdapterAir.isValid [Field F] [Field ExtF]
...
abbrev Valid_Rv32BaseAluAdapterAir (F : Type) [Field F] (ExtF : Type) [Field ExtF] := { c: Rv32BaseAluAdapterAir F ExtF // c.isValid }
