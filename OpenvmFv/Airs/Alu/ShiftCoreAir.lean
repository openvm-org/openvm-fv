...
#define_subair "ShiftCoreAir_4_8" using "openvm_encapsulation" where
  Column["a_0"]
  Column["a_1"]
  Column["a_2"]
  Column["a_3"]
  ...
  Column["c_2"]
  Column["c_3"]
  Column["opcode_sll_flag"]
  Column["opcode_srl_flag"]
  Column["opcode_sra_flag"]
  Column["bit_multiplier_left"]
  Column["bit_multiplier_right"]
  Column["b_sign"]
  Column["bit_shift_marker_0"]
  Column["bit_shift_marker_1"]
  Column["bit_shift_marker_2"]
  Column["bit_shift_marker_3"]
  Column["bit_shift_marker_4"]
  Column["bit_shift_marker_5"]
  Column["bit_shift_marker_6"]
  Column["bit_shift_marker_7"]
  Column["limb_shift_marker_0"]
  Column["limb_shift_marker_1"]
  Column["limb_shift_marker_2"]
  Column["limb_shift_marker_3"]
  Column["bit_shift_carry_0"]
  Column["bit_shift_carry_1"]
  Column["bit_shift_carry_2"]
  Column["bit_shift_carry_3"]

def Valid_ShiftCoreAir_4_8.is_valid
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: F :=
...
lemma Valid_ShiftCoreAir_4_8.is_valid_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
:
  c.opcode_sll_flag row rotation +
...
def Valid_ShiftCoreAir_4_8.right_shift
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: F :=
  c.opcode_srl_flag row rotation +
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.right_shift_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
:
  c.opcode_srl_flag row rotation +
...
def Valid_ShiftCoreAir_4_8.bit_marker_sum
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: Fin 8 → F :=
  λ i => match i with
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_marker_sum_def_1
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
: c.bit_shift_marker_0 row rotation + c.bit_shift_marker_1 row rotation =
  c.bit_marker_sum row rotation 1
:= by simp [Valid_ShiftCoreAir_4_8.bit_marker_sum.eq_def]


@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_marker_sum_def_2
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_marker_sum_def_3
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_marker_sum_def_4
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_marker_sum_def_5
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_marker_sum_def_6
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_marker_sum_def_7
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
def Valid_ShiftCoreAir_4_8.bit_shift
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: F :=
  0 +
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.bit_shift_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
:
...
:= by simp [Valid_ShiftCoreAir_4_8.bit_shift.eq_def]

def Valid_ShiftCoreAir_4_8.limb_marker_sum
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: F :=
  0 +
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.limb_marker_sum_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
:
  0 +
...
def Valid_ShiftCoreAir_4_8.limb_shift
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: Fin 4 → F :=
  λ i => match i with
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.limb_shift_2_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
: c.limb_shift_marker_1 row rotation + 2 * c.limb_shift_marker_2 row rotation =
  c.limb_shift row rotation 2
:= by simp [Valid_ShiftCoreAir_4_8.limb_shift.eq_def]

@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.limb_shift_3_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
def Valid_ShiftCoreAir_4_8.expected_a_left
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: Fin 4 → F :=
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_left_0_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
:= by simp [ Valid_ShiftCoreAir_4_8.expected_a_left.eq_def]; grind

@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_left_1_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_left_2_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_left_3_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
def Valid_ShiftCoreAir_4_8.expected_a_right
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: Fin 4 → F :=
  -- index is j + i in the rust
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_right_0_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
:= by simp [ Valid_ShiftCoreAir_4_8.expected_a_right.eq_def]; grind

@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_right_1_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_right_2_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.expected_a_right_3_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
def Valid_ShiftCoreAir_4_8.b_sign_shifted
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
: F :=
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.b_sign_shifted_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F) (row rotation: ℕ)
:
  c.b_sign row rotation * 255 =
...
def Valid_ShiftCoreAir_4_8.class_offset
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
: F :=
  517

def Valid_ShiftCoreAir_4_8.ctx
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
: AdapterAirContext F :=
...
@[openvm_encapsulation]
lemma Valid_ShiftCoreAir_4_8.ctx.instruction.opcode_def
  [Field F]
  (c : Valid_ShiftCoreAir_4_8 F)
  (row rotation: ℕ)
...
:= by
  unfold Valid_ShiftCoreAir_4_8.ctx Valid_ShiftCoreAir_4_8.class_offset
  simp
